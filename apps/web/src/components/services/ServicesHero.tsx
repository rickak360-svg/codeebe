      ...
      <div className="site-container">
        ...
        >
          ...
          <p className="mx-auto mt-3 max-w-lg text-[13.5px] leading-relaxed text-white/40">
            From idea to scalable product. We design, build, test, and ship
            software — taking full ownership so you can focus on growth.
          </p>

          {/* meta chips */}
          <div className="mt-5 flex items-center justify-center gap-2">
            <div className="flex items-center gap-1.5 rounded-lg border border-white/[0.07] bg-white/[0.03] px-3 py-1.5">
              <MaterialIcon name="widgets" className="!text-[13px] text-[#ff6b00]/60" />
              <span className="font-mono text-[11px] text-white/45">6 core services</span>
            </div>
            <div className="h-3 w-px bg-white/10" />
            <div className="flex items-center gap-1.5 rounded-lg border border-white/[0.07] bg-white/[0.03] px-3 py-1.5">
              <MaterialIcon name="rocket_launch" className="!text-[13px] text-[#ff6b00]/60" />
              <span className="font-mono text-[11px] text-white/45">idea to production</span>
            </div>
          </div>
        </motion.div>
      </div>
