    ...
    <section className="relative overflow-hidden border-b border-white/[0.06] pt-[8rem] pb-20 sm:pt-[9.5rem] sm:pb-24">
      ...
      <div className="site-container relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            Codeebe is a premium product engineering studio. We partner with founders and
            businesses to build SaaS platforms, AI workflows, marketplaces, and custom
            software — with product-first thinking, clean architecture, and launch-ready delivery.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 8 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            >
              <MaterialIcon name="rocket_launch" className="!text-[15px]" />
              Start a Project
            </Link>
            <a
