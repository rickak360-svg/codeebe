    ...
    <section className="border-t border-white/[0.06] bg-white/[0.015] py-20 sm:py-24">
      <div className="site-container">
        ...
        >
          ...
          <p className="relative mb-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#ff6b00]/80">
            Ready to start?
          </p>
          ...
          <p className="relative mx-auto mt-4 max-w-md text-[14px] leading-relaxed text-white/50">
            Tell us about your project and get a detailed estimate, SRS, and delivery roadmap
